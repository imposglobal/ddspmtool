...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    header("Content-Disposition: attachment; filename=clients_lead_generation.csv");
    ...
    fputcsv($output, array('ID', 'Date', 'Client Name', 'Business Name', 'Industry', 'Email ID', 'Contact Number','Category', 'Services Looking', 'Channel', 'Status', 'Notes'));

    // Construct the SQL query with filters
    $sql = "SELECT cid, created_at, client_name, business_name, industry, email_id, contact_number, category, services_looking, channel, status, notes 
            FROM clients";
