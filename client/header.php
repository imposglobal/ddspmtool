...
<div class="d-flex align-items-center justify-content-between">
  <a href="<?php echo $base_url;?>/client/dashboard.php" class="logo d-flex align-items-center">
...
<!-- settings -->
    <li class="nav-item dropdown pe-3">
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
        ...
        <li>
          <a class="dropdown-item d-flex align-items-center" href="<?php echo $base_url;?>/client/logout.php">
