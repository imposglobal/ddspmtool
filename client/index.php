          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="py-4 text-center">
                <a href="<?php echo $base_url;?>/Dashboard/index.php" class="logo w-auto text-center">
                  <img src="https://dds.doodlo.in/assets/img/logo.png" alt="">
                
                  <span class="d-lg-block mt-2">DDS Project Tracking System</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="../API/client/login.php">
