...
require('../sidebar.php');
require('../../API/website_leads_generation_api.php');
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">View Web Leads</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
...
$sql = "SELECT COUNT(*) AS total FROM contact_form WHERE 1=1";
            ...
            <!-- start of drawer -->
             <div class="offcanvas offcanvas-end custom-offcanvas" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
              <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasExampleLabel">View Website Leads Details</h5>
...
document.getElementById('entries_per_page').addEventListener('change', function() {
    ...
    formData.set('entries_per_page', this.value);
    var queryString = new URLSearchParams(formData).toString();
    //window.location.href = 'http://localhost/ddspmtool/Dashboard/websiteleads/view_website_leads.php?' + queryString;
    window.location.href = 'https://dds.doodlo.in/Dashboard/websiteleads/view_website_leads.php?' + queryString;
...
function openLeadDrawer(id) {
    ...
    $.ajax({
        url: "../../API/get_website_leads_details.php",
        type: "GET",
        data: { id: id },
        success: function(response) {
            ...
            bsOffcanvas.show();
             ...
             // Redirect to the same page with id in the URL
             //window.location.href = '../../Dashboard/sales/view_leads.php?id=' + id;
        },
...
function deleteLead(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: "../../API/delete_website_leads.php",
                type: 'POST',
                data: { ops: 'deleteLead', id: id }, 
                success: function (response) {
                    if (response === "true") {
                        Swal.fire({
                            icon: 'success',
